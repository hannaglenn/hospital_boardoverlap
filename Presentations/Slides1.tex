...
\textcolor{purple}{$\implies$ Mergers and overlap have little relationship when considering overlap in the same HRR, but they seem to be substitutes when different HRRs}
\end{frame}
...
\begin{frame}{Estimation}
    ...
    \begin{wideitemize}
        ...
        \item Treatment: gaining or losing affiliation in the same HRR
        \item Only compare to not-yet-treated hospitals
    \end{wideitemize}
\end{frame}

\begin{frame}{Estimation: Stacked DiD}
    Staggered treatment: gaining or losing overlap in the \underline{same market}:
