...
\begin{figure}[p] % 'p' places figure on a dedicated float page
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{bed_conc}
    ...
    \caption{Overall caption for stacked subfigures (part 1)}
\end{figure}
...
\begin{figure}[p]
    ...
    \caption{Overall caption for stacked subfigures (part 2)}
\end{figure}

% Third part of the figure (page 3)
\begin{figure}[p]
    \ContinuedFloat
    \centering
    \begin{subfigure}{\textwidth}
    ...
    \caption{Overall caption for stacked subfigures (part 3)}
\end{figure}
