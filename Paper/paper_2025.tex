...
\end{abstract}
    ...
    In addition to large-scale mergers and acquisitions, growing empirical and policy concern centers on unreported, small-scale mergers and non-merger affiliations. Research shows that small-scale mergers, often called “stealth mergers”, can reduce competition (\cite{majerovitz2021consolidation}; \cite{aggarwal2025stealth}; \cite{wollmann2019stealth}; \cite{wollmann2020get}; \cite{kepler2023stealth}). Additionally, non-merger affiliations encompass structural ties such as joint ventures, management consolidation, and overlapping boards of directors, also referred to as board interlock, that do not trigger merger review. Among these, board overlap is particularly noteworthy because it creates direct governance links between firms, is explicitly addressed under the Clayton Act, and has drawn increasing policy attention. While overlapping boards are documented (\cite{LemleyVanLoo2025OverlappingDirectors}; \cite{Poberejsky2025InterlocksInnovation}), their competitive effects remain largely hypothesized.

    This issue is especially relevant in health care, where consolidation is a persistent concern and several states have begun regulating small-scale mergers and non-merger affiliations (\cite{ncsl2024healthcare}). Additionally, in September 2025, the FTC announced the resignation of three directors from Sevita Health after uncovering board overlap with Beacon Specialized Living Services, both providers of residential care for individuals with disabilities, citing concerns under the Clayton Act and urging firms to proactively avoid such conflicts (\cite{ftc2025sevita}). I construct a measure of non-merger affiliation among U.S. nonprofit hospitals that captures overlapping board members and executive cross-board service, and I examine how these affiliations are related to consolidation and competition.

    I collect data on nonprofit hospital executives and board members from publicly available IRS Form 990 filings to classify hospital affiliations based on leadership teams and geographic market. I define leadership overlap as the presence of a common board member or an executive serving on another hospital’s board, where the two hospitals are otherwise unaffiliated. That is, they do not belong to the same system or network but share leadership ties. Because the hypothesized effects of non-merger affiliations are anti-competitive, whether the affiliated hospitals compete for the same patients is a critical distinction. To capture this, I separate affiliations into those occurring within the same Hospital Referral Region (HRR) and those across different HRRs, where HRRs represent geographic hospital markets (\cite{Wennberg1973SmallAV}). I show that 10\% of nonprofit hospitals in my sample share a leader with an otherwise unaffiliated hospital in the same market, and 25\% of HRRs contain at least one such affiliation.

    I first consider the relationship between leadership overlap and consolidation, where the main goal is to identify whether informal affiliations and mergers are substitutes or complements. I obtain data on whether the hospital is integrated with a system from the American Hospital Association (AHA) survey, and I leverage variation in how harshly mergers are nationally regulated over time as a shock to hospitals' demand for informal affiliations. This analysis shows that mergers in the same HRR are largely unrelated to leadership overlap, but mergers with hospitals in a different HRR are substitutes with leadership overlap. 

    Further, I estimate the effect of gaining or losing leadership overlap on measures of competition and hospital behavior drawn from the hospital consolidation literature: quality, finances, and product differentiation. These outcomes are drawn from several publicly available data sources: the AHA survey, the Healthcare Cost Report Information System (HCRIS), and the Centers for Medicare \& Medicaid Services Hospital Compare data. Similarly to the merger literature, selection into the decision to become affiliated complicates causal inference, as hospitals that gain leadership overlap may differ systematically from those that do not. Therefore, I employ stacked difference-in-differences leveraging timing in gaining or losing leadership overlap, but I restrict the sample to hospitals that eventually gain overlap either in the same HRR or in a different HRR. Within this restricted sample, the treatment group consists of hospitals that gain/lose overlap in the same HRR, while the comparison group includes hospitals that gain/lose overlap in a different HRR but have not yet changed overlap at the event time. I show that overlap improves quality from the patient perspective through better care coordination, and that hospitals tend to offer more services after gaining overlap in the same HRR. Aggregate patient flows and investment decisions are not affected by overlap changes. These results indicate little concern for anti-competitive behavior, and are more consistent with leadership overlap representing other informal affiliations such as joint ventures. 
